...
describe("CategoryComponent Test Suite", () => {
    ...
    describe("CategoryComponent Context Menu", () => {
        ...
        jest.spyOn(require("../../../../middleware/modal/ModalMiddleware"), "openCreateSubCategoryModal").mockImplementation((id) => ({
            payload: id,
            type: "OPEN_CREATE_SUB_CATEGORY_MODAL"
        }));
        jest.spyOn(require("../../../../middleware/modal/ModalMiddleware"), "openUpdateCategoryModal").mockImplementation((id) => ({
            payload: id,
            type: "OPEN_UPDATE_CATEGORY_MODAL"
        }));
        jest.spyOn(require("../../../../middleware/category/CategoryMiddleware"), "deleteCategory").mockImplementation((id) => ({
            payload: id,
            type: "DELETE_CATEGORY"
        }))
        const openContextMenu = (getByText: {
            (id: Matcher, options?: SelectorMatcherOptions): HTMLElement;
            (arg0: string): Element | Node | Document | Window;
        }) => {
